        ...
        <div class="card card-chart">
            ...
            <div class="card-body">
                <div class="mb-3 search-section">
                    <form class="form-text" method="get" action="<?=base_url("Theme/index")?>">
                        <div class="row">
                            ...
                            <div class="search-section col col-lg-8">
                                <div class="input-group">
                                    ...
                                    <input name="search_item" id="search_item" type="text"
                                        class="form-control search-input" placeholder="Search">
                                </div>
                            </div>
                            <div class="search-submit col col-lg-2">
                                <button type="submit" class="btn search-submit-btn btn-sm"><i class="fa fa-search"></i></button>
                            </div>
                        </div>
                    </form>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="td-actions text-right">
                                <a href="Theme/edit/<?php echo $movie->movie_id?>">
                                    <button type="button" rel="tooltip"
                                        class="btn-edit btn btn-success btn-link btn-icon btn-sm">
                                        <i class="tim-icons icon-settings"></i>
                                    </button>
                                </a>
                                <a href="Theme/delete/<?php echo $movie->movie_id?>">
